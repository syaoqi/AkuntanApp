...
<div class="content-wrapper">
    <div class="card">
        <div class="card-body">
            <div class="container">
                <form class="forms-sample" action="<?= base_url("data-penjualan/simpan"); ?>" method="POST">
                    <?= csrf_field(); ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="note" name="note" placeholder="Nama Supplier" value="<?= old("note") ?>">
                    </div>
