            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8 mx-auto">
                        ...
                        <form action="<?= base_url("laporan-buku-besar/filter"); ?>" method="POST">
                            <?= csrf_field(); ?>
                            ...
                            <div class="form-group">
                                <label for="journal_desc">Jenis Beban</label>
                                <select class="form-control <?= ($validation->hasError("journal_desc")) ? "is-invalid" : ""; ?>" id="journal_desc" name="journal_desc">
                                ...
                                <div class="invalid-feedback" role="alert">
                                    <?= $validation->getError("journal_desc") ?>
                                </div>
                            </div>
                            <div class="form-group">
                                <button class="btn btn-primary" id="btn-filter">Tampilkan Buku Besar</button>
                            </div>
                        </form>
                    </div>
                </div>
